...
import { AdminSceduleByClassTable } from "@/app/ui/dashboard/schedules/admin-table";
  ...
  return (
    <div className="default-wrapper">
      ...
      <div className="flex items-center justify-between gap-6">
        <CreateButton
          href={ADMIN_CLASS_BASE_PATH + `/${id}/schedules/create`}
          label="Create"
        />
      </div>

      <Suspense key={currentPage} fallback={<TableSkeleton />}>
        <AdminSceduleByClassTable id={id} currentPage={currentPage} />
      </Suspense>
    </div>
  );
}
